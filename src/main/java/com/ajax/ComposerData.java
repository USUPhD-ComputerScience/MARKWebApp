...
public class ComposerData {
    ...
    public ComposerData() {
        ...
        composers.put("51", new Composer("51", "Carl", "Orff", "Post-Romantic")); 
        composers.put("52", new Composer("52", "Carl", "Orff", "Post-Romantic")); 
        composers.put("53", new Composer("53", "Carl", "Orff", "Post-Romantic")); 
        composers.put("54", new Composer("54", "Carl", "Orff", "Post-Romantic")); 
        composers.put("55", new Composer("55", "Carl", "Orff", "Post-Romantic")); 
        composers.put("56", new Composer("56", "Carl", "Orff", "Post-Romantic")); 
        composers.put("57", new Composer("57", "Carl", "Orff", "Post-Romantic")); 
        composers.put("58", new Composer("58", "Carl", "Orff", "Post-Romantic")); 
        composers.put("59", new Composer("59", "Carl", "Orff", "Post-Romantic")); 
        composers.put("60", new Composer("60", "Carl", "Orff", "Post-Romantic")); 
        composers.put("61", new Composer("61", "Carl", "Orff", "Post-Romantic")); 
        composers.put("62", new Composer("62", "Carl", "Orff", "Post-Romantic")); 
        composers.put("63", new Composer("63", "Carl", "Orff", "Post-Romantic")); 
        composers.put("64", new Composer("64", "Carl", "Orff", "Post-Romantic")); 
        composers.put("65", new Composer("65", "Carl", "Orff", "Post-Romantic")); 
        composers.put("66", new Composer("66", "Carl", "Orff", "Post-Romantic")); 
        composers.put("67", new Composer("67", "Carl", "Orff", "Post-Romantic")); 
        composers.put("68", new Composer("68", "Carl", "Orff", "Post-Romantic")); 
        composers.put("69", new Composer("69", "Carl", "Orff", "Post-Romantic")); 
        composers.put("70", new Composer("70", "Carl.Johann.Sebastian.Benjamin.Leonard", "Orff", "Post-Romantic")); 
